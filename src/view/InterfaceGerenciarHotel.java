...
public class InterfaceGerenciarHotel extends JFrame{
	...
	private void initialize() {
		...
		getContentPane().add(selecionar_1);
		...
		getContentPane().add(selecionar_2);
		...
		getContentPane().add(selecionar_3);
		...
		JButton Visualizar = new JButton("INICIO");
